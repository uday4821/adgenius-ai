  ...
  return (
    <section id="industries" className="py-20 md:py-32 bg-card/30 relative" aria-labelledby="industries-heading">
      ...
      <div className="container relative z-10">
        ...
        {/* Industry Cards Grid */}
        <nav aria-label="Industries served" className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 md:gap-6">
          {industries.map((industry, index) => (
            ...
            >
              <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-gradient-to-br from-primary/10 to-secondary/10 flex items-center justify-center group-hover:from-primary/20 group-hover:to-secondary/20 transition-all duration-300" aria-hidden="true">
